package com.cenfotec.jtestproject.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cenfotec.jtestproject.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cenfotec.jtestproject.repository.UserRepository.USERS_BY_EMAIL_CACHE);
