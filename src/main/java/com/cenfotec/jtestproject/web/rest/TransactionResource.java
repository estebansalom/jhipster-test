...
import com.cenfotec.jtestproject.repository.TransactionRepository;
...
/**
 * REST controller for managing {@link com.cenfotec.jtestproject.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Transaction> result = transactionRepository
            ...
            .map(
                existingTransaction -> {
                    ...
                    if (transaction.getPeriodic() != null) {
                        existingTransaction.setPeriodic(transaction.getPeriodic());
                    }
