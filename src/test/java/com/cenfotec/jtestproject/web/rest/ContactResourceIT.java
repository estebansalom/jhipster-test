...
import com.cenfotec.jtestproject.domain.Contact;
import com.cenfotec.jtestproject.repository.ContactRepository;
...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().name(DEFAULT_NAME).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
        return contact;
    }
    ...
    void putNewContact() throws Exception {
        ...
        updatedContact.name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
